...
router.put("/auth/update-details", protect.protect, authController.updateDetails);
router.put("/auth/update-password", protect.protect, authController.updatePassword);
